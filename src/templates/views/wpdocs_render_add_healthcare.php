...
if (isset($_GET['id'])) {
    ...
    $already_fields = maybe_unserialize($patient_data->healthcare_details) ?? [];
}
...
<div class="wrap">
    <h2><?php _e('Add Healthcare', 'ebakim-wp'); ?></h2>
    <form method="POST" action="<?php echo admin_url('admin-post.php'); ?>" style="max-width: 600px">
        <input type="hidden" name="action" value="ebakim_add_healthcare">
        ...
        <?php submit_button(__('Add Healthcare', 'ebakim-wp')); ?>
    </form>
</div>
<script>
